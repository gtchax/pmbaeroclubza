...
export function useCreateEvaluation() {
  ...
  return useMutation({
    mutationFn: (data: CreateEvaluationData & { instructorId: string }) => createEvaluation(data),
    onSuccess: () => {
...
export function useUpdateEvaluation() {
  ...
  return useMutation({
    mutationFn: ({ evaluationId, data }: { evaluationId: string; data: Partial<CreateEvaluationData> }) => 
...
export function useAddSkillAssessment() {
  ...
  return useMutation({
    mutationFn: ({ evaluationId, skillData }: { 
      evaluationId: string
      skillData: {
        skillName: string
        skillArea: string

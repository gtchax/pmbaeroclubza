...
export function EvaluationsContent() {
  ...
  const evaluations: Evaluation[] = [
    {
      ...
      skills: [
        {
          name: "Navigation",
          score: 90,
          notes: "Excellent use of GPS and pilotage",
        },
        {
          name: "Radio Communications",
          score: 75,
          notes: "Needs improvement in clarity",
        },
        { name: "Flight Planning", score: 88, notes: "Thorough preparation" },
        {
          name: "Weather Assessment",
          score: 82,
          notes: "Good understanding of conditions",
        },
        {
          name: "Emergency Procedures",
          score: 85,
          notes: "Confident responses",
        },
      ],
      strengths: [
        "Navigation skills",
      ...
      instructorNotes:
        "Alex shows excellent progress and is demonstrating commercial-level skills. Recommend scheduling checkride within 2 weeks.",
      status: "completed",
      nextSteps: [
        "Schedule checkride",
    ...
    },
    {
      ...
      skills: [
        { name: "Takeoffs", score: 80, notes: "Consistent and smooth" },
        {
          ...
          score: 75,
          notes: "Good spacing and altitude control",
        },
        { name: "Landings", score: 65, notes: "Inconsistent flare timing" },
        {
          name: "Crosswind Handling",
          score: 60,
          notes: "Needs significant practice",
        },
      ...
      recommendations:
        "Continue pattern work with focus on crosswind landings.",
      instructorNotes:
        "Maria is progressing well but needs more practice with landings, especially in crosswind conditions.",
      status: "completed",
      nextSteps: [
        "Additional crosswind practice",
        "Landing consistency drills",
        "Rudder control exercises",
      ],
    },
    {
      id: "EVAL-003",
      ...
      skills: [
        { name: "Aircraft Control", score: 82, notes: "Smooth and confident" },
        {
          name: "Traffic Pattern",
          score: 80,
          notes: "Good pattern discipline",
        },
        {
          name: "Landings",
          score: 75,
          notes: "Consistent approach and landing",
        },
        {
          name: "Emergency Procedures",
          score: 78,
          notes: "Good knowledge and execution",
        },
      ...
      recommendations:
        "Ready for first solo flight with instructor endorsement.",
      instructorNotes:
        "John demonstrates the skills and judgment necessary for solo flight. Recommend solo endorsement.",
      status: "completed",
  ...
  const filteredEvaluations = evaluations.filter(
    (ev) => filterStatus === "all" || ev.status === filterStatus
  );
      ...
      {viewMode === "grid" ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {paginatedEvaluations.map((evaluation) => (
            <Card
              key={evaluation.id}
              className="bg-[#262626] border-gray-600 hover:border-[#f6d57f] transition-colors cursor-pointer"
            ...
            >
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`w-3 h-3 rounded-full ${getStatusColor(evaluation.status)}`}
                  />
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-lg font-bold ${getScoreColor(evaluation.overallScore)}`}
                  >
                  ...
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                      ...
                      <div>
                        ...
                        <p
                          className={`font-bold ${getScoreColor(evaluation.overallScore)}`}
                        >
                          {evaluation.overallScore}%
                        </p>
                      </div>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <p className="text-sm text-gray-400">
            ...
            {Math.min(startIndex + itemsPerPage, filteredEvaluations.length)} of{" "}
                  ...
                  {selectedEvaluation.skills.map((skill, index) => (
                    <div key={index} className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`text-sm font-medium ${getScoreColor(skill.score)}`}
                        >
                          {skill.score}%
                        </span>
                      </div>
